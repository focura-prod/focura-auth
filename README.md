...
| Package | Description |
|---|---|
| [`@focura/auth-core`](./packages/core) | Express.js backend auth — JWT, sessions, middleware |
| [`@focura/auth-next`](./packages/next) | Next.js frontend — NextAuth, components, hooks |
